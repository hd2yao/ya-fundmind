...
当前文档同时维护稳定运行的 V1/V2 基线和正在交付的 V3 Fund Information Platform。稳定产品版本为 `v2.6.0`；V3 M1 已发布 `v3.0.0-alpha.1`，下一交付门为 M2 Fund Profile Data。各大版本使用有限 Milestone 和明确发布门，不使用无限 Phase 追加方式。
