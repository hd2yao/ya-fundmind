...
当前文档同时维护稳定运行的 V1/V2 基线和正在交付的 V3 Fund Information Platform。稳定产品版本为 `v2.6.0`；V3 M1、M2 已分别发布 `v3.0.0-alpha.1` 和 `v3.0.0-alpha.2`，下一里程碑 M3 尚未开始实现。各大版本使用有限 Milestone 和明确发布门，不使用无限 Phase 追加方式。
...
- `releases/v3.0.0-alpha.2-release-report.md`：M2 alpha.2 发布证据、边界和回滚。
