...
当前稳定版本为 `v2.0.0`：M1-M5 用户能力、M6 技术加固，以及 2026-07-15、16、17 三个不同日期的 post-RC scheduler provenance、provider quality 和 strict contract 门均已完成；PR/CI/merge/tag 与 post-release check 全部通过。
