...
- 当前稳定版本：`v2.3.0` Fund Research Desk。
- 当前开发轨道：`v2.3` 已完成；后续按 `v2.4` 基金独立详情、`v2.5` 组合工作台、`v2.6` 新闻/公告证据浏览器的有限版本计划推进。
- 当前 Milestone：`v2.4` Fund Data Terminal & Detail。
- 当前 P0：无。
- 当前 P1：无。
...
- 组合和证据页的基金引用可进入详情；不触发隐式 live provider 调用。
